...
var generateDots = function generateDots(count) {
  return Array(count || 7).fill().map(function (_, i) {
    return _react2.default.createElement('div', { className: 'ball', key: _shortid2.default.generate() });
  });
};
...
var App = function App() {
  return _react2.default.createElement(
    'div',
    { id: 'App', className: 'container', style: style },
    generateDots(6),
